...
class FieldPaginator:
    def __init__(
        self, bot: commands.Bot, *, base_embed: discord.Embed = discord.Embed(),
    ):
        self.bot = bot
    ...
    async def send(
        self, *, target: discord.abc.Messageable, owner: discord.User,
    ):
    ...
    async def loop(
        self, *, message: discord.Message, owner: discord.User,
    ):
        page = 0
